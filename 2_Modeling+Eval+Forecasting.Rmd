...
final_models <- ev_ts_sales %>%
  model(
    bev_best  = ARIMA(sales),   # replace with your winner
    phev_best = TSLM(sales),     # replace with your winner
    fcev_best = ARIMA(sales ~ trend())   # replace with your winner
  )


#Final. forecast for the next 7 years
future <- new_data(ev_ts_sales, n = 7)   # 2024–2030
